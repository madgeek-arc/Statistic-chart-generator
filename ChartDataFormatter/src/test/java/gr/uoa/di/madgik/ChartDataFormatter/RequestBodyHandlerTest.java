...
public class RequestBodyHandlerTest {
    ...
    @Test
    public void handleRequestTest() throws IOException, RequestBodyHandler.RequestBodyException {

        ObjectMapper mapper = new ObjectMapper();
        RequestInfo requestInfo = mapper.readValue(new File("src/test/resources/multiTypeRequestInfo.json"), RequestInfo.class);
